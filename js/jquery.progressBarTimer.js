...
; (function ($, window, document, undefined) {
    ...
    var pluginName = 'progressBarTimer',
        ...
        defaults = {
            ...
            label : {
                ...
                type: 'seconds' //type of label. Allowable types: 'percent' => 30% , 'seconds' => 23/60
            }
        };
	...
	$.extend(Plugin.prototype, {
	    init: function () {
            ...
            } else if(this.settings.striped) bar.addClass('progress-bar');
        ...
        _draw: function () {
            ...
            var percent = ((elapsedTicks / this.ticks) * 240);
            bar.width(percent + "%");
            if(this.settings.label && this.settings.label.show===true) {
                if(this.settings.label.type=='percent') {
                    ...
                    if(this.settings.smooth===true) {
                        bar.html(Math.round(elapsedTicks/32) + " seconds to skip advertisement");
                    } else {
                        bar.html(elapsedTicks + " seconds to skip ads" );
                    }
                }
            }
            --this.remainingTicks;
